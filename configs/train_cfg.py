...
num_dec_layer = 6
lambda_2 = 2.0
pretrained = '/data2/607_LRK_dataset/data/dualvit_s_384.pth.tar'
    ...
    dict(type='LoadMultiModalitiesImages',
         mod_path_mapping_dict={
             ...
             'STCrowd': {
                 ...
                 'extra_mod_img': {
                     'org_key': 'STCrowd_Raw/left',
                     'target_key': 'STCrowd_Raw/pcd_mask_test'
                 }
             },
             'evs_human_1013': {
                 'img': {
...
ann_prefix = '/home/zhangyong/lrk/_datasets_datasets_ann/LLVIP/'
ann_prefix2 = '/home/zhangyong/lrk/_datasets_datasets_ann/InOutDoorPeopleRGBD/coco_ann/'
ann_prefix3 = '/home/zhangyong/lrk/_datasets_datasets_ann/evs_dataset/evs_human_1013/'
ann_prefix4 = '/home/zhangyong/lrk/_datasets_datasets_ann/STCrowd_Raw/coco_ann/'
# ann_prefix5 = 'YOUR_DTAT_ROOT_PATH_datasets_ann/crowdhuman_coco/'

train_ann_list = [
    ann_prefix + 'LLVIP_coco_train_change_cat_id.json', # 训练集
]

img_prefix_list = [
    '/home/zhangyong/lrk/_datasets/_images/LLVIP/visible/train/',
    '/home/zhangyong/lrk/_datasets/_images/InOutDoorPeopleRGBD/Images/',
    '/home/zhangyong/lrk/_datasets/_images/evs_human_1013/train/rgb/',
    '/home/zhangyong/lrk/_datasets/_images/STCrowd_Raw/',
#     'YOUR_DTAT_ROOT_PATH/_images/CrowdHuman',
]
val_list = [
...
val_img_prefix_list = [
    '/home/zhangyong/lrk/_datasets/_images/LLVIP/visible/test/',
        # '/home/zhangyong/lrk/_datasets/_images/LLVIP/infrared/test/',
    # '/data2/607_LRK_dataset/data/_images/InOutDoorPeopleRGBD/Images/',
    # '/home/zhangyong/lrk/_datasets/_images/evs_human_1013/val/rgb/',
    # '/home/zhangyong/lrk/_datasets/_images/STCrowd_Raw/',
#     'YOUR_DTAT_ROOT_PATH/_images/CrowdHuman/',
]
...
evaluation = dict(
    ...
    crowdhuman_odgt_val_gt_path='/home/zhangyong/lrk_datasets_ann/crowdhuman_raw/annotation_val.odgt')
...
log_level = 'INFO'
load_from = '/data2/607_LRK_dataset/data/pretrained.pth'
