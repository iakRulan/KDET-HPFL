...
def gen_all_lidar_mask(
        ann_path='',
        camera_info_path='',
        data_root_prefix='/data2/607_LRK_dataset/data/STC/STCrowd_official/'):
    ...
    for img_info in ann_json['images']:
        # print(f"Total images in annotation file: {len(ann_json['images'])}")
...
ann_path = '/data2/607_LRK_dataset/data/STC/STCrowd_official/val_set.json'
ann_path2 = '/data2/607_LRK_dataset/data/STC/STCrowd_official/train_set.json'
camera_info_path = '/data2/607_LRK_dataset/data/STC/STCrowd_official/camera.json'
data_root_prefix = '/data2/607_LRK_dataset/data/STC/STCrowd_official/'
ann_json = load_jsonfile(ann_path)
...
# 定义必要的路径参数
ann_path = '/data2/607_LRK_dataset/data/STC/STCrowd_official/train_set.json'  # 训练集标注文件
camera_info_path = '/data2/607_LRK_dataset/data/STC/STCrowd_official/camera.json'  # 相机参数文件
data_root_prefix = '/data2/607_LRK_dataset/data/STC/STCrowd_official/'  # 数据根目录
